            ...
            <Layout headerStyle={1} footerStyle={1}>
                <div className="single-project relative themesflat-container mb-30">
                    <div className="flex row wrapper-content justify-center">
                        <div className='col-4 mb-30 mt-30 profile flex flex-col align-center justify-center'>
                            <img
                                src={user?.avatar}
                                alt="User Avatar"
                                style={{
                    ...
                    <div className="widget-content-inner row">
                        {
                            createdProjects.map(project => {
                                return (
                                    <div className="wrap-box-card col-4" key={`project-${project?._id}`}>
                    ...
                    <div className="widget-content-inner row">
                        {
                            backedProjects.map(project => {
                                return (
                                    <div className="wrap-box-card col-4" key={`project-${project?.project?._id}`}>
                                        <div className="col-item">
                                            <div className="tf-card-box style-1">
                                                <div className="card-media">
                                                    <Link href="#">
                                                ...
                                                <div className="meta-info flex items-center justify-between">
                                                    <div className="view-col w-full">
                                                        ...
                                                        <div className="w-full h-10 bg-white border-radius-10">
                                                            <div
                                                                className="bg-secondary h-10 border-radius-10"
                                                                style={{ width: `${Math.floor((project?.project?.fundedAmount / project?.project?.goal) * 100)}%` }}
                                                            />
                                                        </div>
                                                        <span className="font-medium">{`${Math.floor((project?.project?.fundedAmount / project?.project?.goal) * 100)}% of $${project?.project?.goal?.toLocaleString()}`}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
